...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "metric-value warn" },
});
(__VLS_ctx.data?.expiringIn30Days ?? '-');
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "metric-sub" },
});
(__VLS_ctx.data?.expiringIn7Days ?? 0);
var __VLS_19;
var __VLS_15;
...
(__VLS_ctx.formatMoney(__VLS_ctx.data?.revenueLast30Days));
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "metric-sub" },
});
(__VLS_ctx.data?.paidOrdersLast30Days ?? 0);
var __VLS_27;
var __VLS_23;
...
(__VLS_ctx.formatMoney(__VLS_ctx.data?.revenueThisYear));
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "metric-sub" },
});
(__VLS_ctx.data?.disabledTenants ?? 0);
(__VLS_ctx.data?.expiredTenants ?? 0);
var __VLS_35;
var __VLS_31;
var __VLS_3;
...
const __VLS_41 = __VLS_asFunctionalComponent(__VLS_40, new __VLS_40({
    data: (__VLS_ctx.data?.recentSubscriptions ?? []),
    emptyText: "暂无数据",
}));
...
__VLS_59.slots.default;
{
    ...
    const __VLS_61 = __VLS_asFunctionalComponent(__VLS_60, new __VLS_60({
        type: (row.source === 'OnlinePayment' ? 'success' : 'info'),
    }));
